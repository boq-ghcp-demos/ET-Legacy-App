...
A comprehensive desktop application built with VB.NET for managing personal and business expenses in AUD with support for recurring payments and tax-deductible tracking.
...
- Support for multiple frequencies (Weekly, Fortnightly, Monthly, Quarterly, Annually)
...
### Single Currency - AUD
- All expenses are tracked in AUD (Australian Dollar)
- Simplified currency handling for cleaner app experience
