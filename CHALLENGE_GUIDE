...
*   Allow users to select a currency for their expenses ( sample API https://www.exchangerate-api.com/).
...
### 4.2. No major bugs or vulnerabilities in the final release
**Goal:** Deliver a high-quality application.
*   Conduct thorough testing cycles.
*   Address and resolve all identified bugs and vulnerabilities before release. 
